...
$(function () {
    ...
    $(".first_dt").css("background-image", "url(images/left/showdown.jpg)");    
    /**一级菜单项单击事件**/
    $(".leftsidebar_box dt").click(function () {
        ...
        if ($(this).parent().find('dd').is(":hidden")) {
            ...
            $(this).parent().parent().find("dt").css("background-image", "url(images/left/showup.jpg)");
            //再打开当前的菜单
            $(this).parent().find('dd').slideToggle(); //滑动方式展开子菜单                              
            $(this).css("background-image", "url(images/left/showdown.jpg)");
        }
        else {
            $(this).parent().find('dd').slideUp(); //滑动方式隐藏子菜单                
            $(this).css("background-image", "url(images/left/showup.jpg)");
        }
    });
